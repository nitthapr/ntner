...
class CRFDecoder(nn.Module):
    ...
    def forward(self, inputs, labels_mask, labels):
        ...
        #add by prapas to calculate feed forward loss
        ...
        #end - add by prapas
        return preds, -loglik.mean() #edit by prapas add -loglik.mean() to return
...
class NCRFDecoder(nn.Module):
    ...
    def forward(self, inputs, labels_mask, labels):
        ...
        preds = preds[:, :, 0]
        return preds, crf_score #edit by prapas add crf_score to return
