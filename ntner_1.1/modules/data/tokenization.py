...
from modules.data.bpe_helper import BPE
...
class ThaiTokenizer(object):
  ...
  def __init__(self, vocab_file, spm_file,
    ...
    self.model_input_names = model_input_names # from tokenization_utils_base.PreTrainedTokenizerBase with some modification
